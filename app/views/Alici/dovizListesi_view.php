  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Borsamızdaki alıcıların döviz listesi:</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Alıcı Doviz Bilgileri</h3>
         ...
         function build_table($array){
            ...
            echo "<tbody>";
                foreach( $array as $key=>$value){
                    ...
                    $html .= '<td>' . '<a href="'.SITE_URL.'/Admin/dovizCevir/'. $value["Id"] .'" title="Dövizi Tl ye çevir" data-toggle="tooltip"><span class="btn btn-block btn-success" >Dövizi Tl ye çevir</span></a>' . '</td>';
                    $html .= '</tr>';
                }
