...
<head>
  ...
  <title>Tarim Borsası | Dashboard</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Alıcı Fiyat Bilgi Girişi</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <section class="content">
      <div class="container-fluid">
          <form class="form-inline ml-3" action="<?php echo SITE_URL; ?>/Alici/dovizEklendi" method="post">
            <div class="input-group input-group-sm">
                <table class="center"> 
                <tr>
                  <td> <label>Alıcı</label></td>
                  <td>
                      <input type="text" class="form-control" value="<?php echo Session::get("username");?>" name="alici">                  
                  </td>
                </tr>
                <tr>
                  <td><label>Miktar</label></td>
                  <td> <input type="text" class="form-control" placeholder="Döviz" name="fiyati"></td>
                </tr>
                <tr>
                    <td>
                        <label>Doviz Cinsi</label>
                    </td>
                    <td>
                         <select class="form-control" name="doviz_cinsi">
                          <option   selected="selected">Döviz Cinsini Seçiniz</option>
                          <option value="ABD DOLARI">ABD DOLARI</option>
